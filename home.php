...
<!--begin row 1-->
<tr><th><form action = "http://tango.berea.edu/lambertq/FacultyDB/SingleSearch/index.php" method = "post">
		 <input type="Submit" value = "Faculty Single Search" name = "PageChange"/>
		 </form>
</th><th><form action = "http://tango.berea.edu/lambertq/FacultyDB/SingleSearch/index.php" method = "post">
